...
public class TemperatureMonitorConfigureActivity extends Activity {
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            autoUpdateCheckbox = (CheckBox) findViewById(R.id.checkAutoUpdate);
            Preferences preferences = new Preferences(sensorValue, isFahrenheit, autoUpdateCheckbox.isChecked());
    ...
    public void onCreate(Bundle icicle) {
        ...
        autoUpdateCheckbox = (CheckBox)findViewById(R.id.checkAutoUpdate);
        autoUpdateCheckbox.setChecked(preferences.isAutoUpdate());
